...
import { stockReferralsInfo } from 'constants/index';
  ...
  return (
    ...
    >
      ...
      <Stack my="20px" direction="column" gap={4}>
        {stockReferralsInfo.map((bar) => <ProgressBar key={bar.title} {...bar} />)}
      </Stack>
    </Box>
  )
}

export default StockReferrals